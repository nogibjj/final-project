...
async def Complete_Pokedex(request: Request):
    ...
    return templates.TemplateResponse(
        "form.html", {"request": request, "columns": columns, "results": result}
    )
...
async def Filter_Previous_Query_Result(
    request: Request, c1: str, c2: str, c3: str, c4: str, c5: str, c6: str
):
    conn, cursor = connect_db()
    comma = ","
